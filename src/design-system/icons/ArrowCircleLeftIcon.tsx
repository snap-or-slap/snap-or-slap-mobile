...
type ArrowCircleLeftIconVariant = (typeof availableVariants)[number];

function normalizeVariant(variant?: IconVariant): ArrowCircleLeftIconVariant {
  if (variant && availableVariants.includes(variant as any)) {
    return variant as ArrowCircleLeftIconVariant;
  }
  return 'outline';
}
