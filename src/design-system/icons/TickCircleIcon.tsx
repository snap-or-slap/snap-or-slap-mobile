...
type TickCircleIconVariant = (typeof availableVariants)[number];

function normalizeVariant(variant?: IconVariant): TickCircleIconVariant {
  if (variant && availableVariants.includes(variant as any)) {
    return variant as TickCircleIconVariant;
  }
  return 'outline';
}
